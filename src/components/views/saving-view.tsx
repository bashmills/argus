    ...
    <div className="w-full flex flex-col justify-center items-center">
      <div className="w-full min-h-96 rounded-xl border-2 flex flex-col justify-center items-center text-center border-gray-600 bg-gray-500/10 space-y-6 p-6">
        ...
        <div className="w-full flex flex-col justify-center items-center space-y-3">
          <h2 className="text-2xl font-semibold text-white">Saving Assets</h2>
          <p className="text-sm text-gray-400">Saving selected assets to chosen path. This may take a while depending on number of assets.</p>
        </div>
